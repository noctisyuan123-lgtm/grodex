...
| **G3** | **Partial — chat slice landed** (`docs/G3-chat-slice.md`, `docs/G3b-timeline-slice.md`): connect + prompt + SSE + TextRoll/tool timeline/activity strip; subagent cards / full process stack deferred |
...
Desktop (G2) lives under `apps/` — run notes in [`docs/G2-desktop-skeleton.md`](docs/G2-desktop-skeleton.md). G3 chat: [`docs/G3-chat-slice.md`](docs/G3-chat-slice.md). G3b timeline/activity: [`docs/G3b-timeline-slice.md`](docs/G3b-timeline-slice.md).
